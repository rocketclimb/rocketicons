...
- Generate English and idiomatic Brazilian Portuguese together. Do not merely preserve untranslated English terms when a normal Portuguese term exists.
...
- Do not add a context solely because a word happens to occur in the icon ID.
