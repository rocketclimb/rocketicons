...
- [ ] Add synonyms and semantic tags without changing stable icon IDs. **Partial:** reviewed English and PT-BR semantics cover all 219 Weather Icons, 189 Simple Line Icons, 287 Feather Icons, 192 Devicons, 332 Radix Icons, 288 Circum Icons, 329 Flat Color Icons, 1 Rocketicons icon, 336 Typicons, 352 Themify Icons, 653 VS Code Codicons, 460 Heroicons, 972 Heroicons 2 icons, 491 IcoMoon Free icons, 637 Grommet Icons, 704 css.gg icons, and 696 Ionicons (7,138 total) across 17 collections with complete current-source coverage. BoxIcons has complete generated coverage for 1,634 bindings, validated structurally and in the dry-run index; its per-family semantic review remains outstanding. The other 14 collections remain pending.
...
- [ ] Roll reviewed semantic metadata out to the remaining collections, prioritizing small and high-usage collections. **Partial:** Weather Icons, Simple Line Icons, Feather Icons, Devicons, Radix Icons, Circum Icons, Flat Color Icons, Rocketicons, Typicons, Themify Icons, VS Code Codicons, Heroicons, Heroicons 2, IcoMoon Free, Grommet Icons, css.gg, and Ionicons have reviewed metadata for 7,138 icon bindings across 17 of 32 collections. BoxIcons adds complete generated coverage for 1,634 bindings (8,772 generated bindings across 18 collections), validated against its pinned source and the dry-run index; semantic review is still required before it is counted as reviewed. Go currently reports 1 missing, 4 stale, and 80 orphaned bindings against the current lockfile-installed Octicons catalog and needs a refresh before it is counted as reviewed.
- [ ] Refresh Go and Radix metadata against the current clean-build catalog. **Partial:** Radix is current; Go needs a refresh because its current status reports 1 missing, 4 stale, and 80 orphaned bindings.
- [ ] Normalize names and common aliases, such as `delete`, `trash`, and `remove`. **Partial:** implemented and materialized per icon for Weather Icons, Simple Line Icons, Feather Icons, Go Icons, Devicons, Radix Icons, Circum Icons, Flat Color Icons, Rocketicons, Typicons, Themify Icons, VS Code Codicons, Heroicons, IcoMoon Free, Grommet Icons, css.gg, and Ionicons.
...
- [ ] Record visual properties such as filled, outlined, brand, directional, multicolor, and stroke support. **Partial:** deterministic properties are generated for enriched Weather Icons, Simple Line Icons, Feather Icons, Devicons, Radix Icons, Circum Icons, Flat Color Icons, Rocketicons, Typicons, Themify Icons, VS Code Codicons, Heroicons, Heroicons 2, IcoMoon Free, Grommet Icons, css.gg, Ionicons, and BoxIcons.
- [ ] Add negative guidance for easily confused icons. **Partial:** supported by the schema and present for ambiguous Weather Icons, Simple Line Icons, Feather Icons, Devicons, Radix Icons, Circum Icons, Flat Color Icons, Rocketicons, Typicons, Themify Icons, VS Code Codicons, Heroicons, Heroicons 2, IcoMoon Free, Grommet Icons, css.gg, and Ionicons; negative terms are intentionally excluded from Algolia's positive search attributes.
...
- [ ] Create a reviewed benchmark of common icon-selection requests. **Partial:** collection-wide semantic invariants, unrelated alias leakage, and 40 bilingual intent cases across the eight collections added in this rollout are covered; a representative scored ranking corpus remains pending.
