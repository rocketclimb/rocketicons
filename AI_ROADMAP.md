...
- [ ] Roll reviewed semantic metadata out to the remaining collections, prioritizing small and high-usage collections. **Partial:** Weather Icons, Simple Line Icons, Feather Icons, Go Icons, Devicons, Radix Icons, Circum Icons, Flat Color Icons, Rocketicons, Typicons, Themify Icons, VS Code Codicons, Heroicons, IcoMoon Free, Grommet Icons, css.gg, Ionicons, and BoxIcons have reviewed metadata for 8,152 icon bindings across 18 of 32 collections. Go is verified against the lockfile-installed Octicons 19.34.0 catalog; Radix, Codicons, Grommet, and BoxIcons are verified against their current pinned revisions.
