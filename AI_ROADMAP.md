...
- [ ] Extend the release pipeline to publish `@rocketicons/utils`, `@rocketicons/tailwind`, `@rocketicons/toolkit`, and `@rocketicons/mcp` in dependency order before the `rocketicons` package. **Partial:** Cut Release now generates all collections automatically before workspace tests and verifies every generated export and catalog record; build failures propagate to CI. New workspace version baselines are initialized automatically, and exact internal dependency pins are aligned after version bumps. CLI runtime requirements are generated from the packaged runtime versions; initialization respects explicit and inherited baseUrl settings. An explicit refresh can regenerate artifacts for an untouched open release PR using a leased branch update. The repository token pushes the branch and explicitly dispatches validation; the PR credential is only used for PR access, so it does not need repository write permission. The release 0.10.0 merge exposed a cut lookup failure that recovered on retry, squash-merge conflicts during branch synchronization, and npm E404 when publishing the first scoped package. The retry created the release tag but did not publish the new packages. Proposed lookup, synchronization, npm-access, and safe-retry fixes are recorded in [the release recovery proposal](docs/proposals/release-recovery-2026-09-26.md); implementation and public npm installation verification remain pending.
...
- [ ] Add synonyms and semantic tags without changing stable icon IDs. **Partial:** reviewed English and PT-BR semantics cover all 219 Weather Icons, 189 Simple Line Icons, 287 Feather Icons, 352 Go Icons, 192 Devicons, 332 Radix Icons, 288 Circum Icons, 329 Flat Color Icons, 1 Rocketicons icon, 336 Typicons, 352 Themify Icons, 653 VS Code Codicons, 460 Heroicons, 972 Heroicons 2, 491 IcoMoon Free icons, 637 Grommet Icons, 704 css.gg icons, 696 Ionicons, 848 Ant Design Icons, 6,184 Tabler icons, 1,332 Ionicons 5 icons, 1,611 Font Awesome 5 icons, 1,544 Line Awesome icons, 1,634 BoxIcons icons, 2,754 Bootstrap Icons, 2,058 Font Awesome 6 icons, 4,040 Game Icons, 4,341 Material Design icons, 9,072 Phosphor icons, 3,188 Remix icons, 3,458 Simple Icons, and 2,048 Lucide icons (51,602 reviewed bindings across 32 of 33 collections). Lucide's 2,047 bilingual semantic families are verified against lockfile-installed lucide-static 1.41.0. MynaUI adds 2,620 generated icons at pinned revision `579977f9afb1991c24a32da73417a9cbcc4d5b22`; bilingual semantic review remains pending.
...
- [ ] Roll reviewed semantic metadata out to the remaining collections, prioritizing small and high-usage collections. **Partial:** Weather Icons, Simple Line Icons, Feather Icons, Go Icons, Devicons, Radix Icons, Circum Icons, Flat Color Icons, Rocketicons, Typicons, Themify Icons, VS Code Codicons, Heroicons, Heroicons 2, IcoMoon Free, Grommet Icons, css.gg, Ionicons, Ant Design Icons, BoxIcons, Font Awesome 5, Tabler, Ionicons 5, Line Awesome, Bootstrap Icons, Font Awesome 6, Game Icons, Material Design, Phosphor, Remix, Simple Icons, and Lucide have reviewed metadata for 51,602 icon bindings across 32 of 33 collections. Lucide has 2,047 bilingual semantic families verified against lockfile-installed `lucide-static` 1.41.0, with no missing or stale bindings. Font Awesome 5 is now verified against pinned Git revision `afecf2af5d897b763e5e8e28d46aad2f710ccad6`; Ant Design is verified against pinned Git revision `7f2516ac91226d2b41f93b35cb5197c8d94f7189`; Heroicons 2 is verified against pinned revision `616b7a4dbbf3d011760af8066262cd5c6b3868f3`; Go is verified against the lockfile-installed Octicons 19.34.0 catalog; Radix, Codicons, and Grommet are verified against their current pinned revisions. MynaUI adds 2,620 generated bindings across 1,310 regular/solid families, bringing the catalog to 54,222 icons across 33 collections; its semantic review, dry-run index validation, and full static export remain pending.
- [x] Refresh Go and Radix metadata against the current clean-build catalog.
- [ ] Normalize names and common aliases, such as `delete`, `trash`, and `remove`. **Partial:** implemented and materialized per icon for Weather Icons, Simple Line Icons, Feather Icons, Go Icons, Devicons, Radix Icons, Circum Icons, Flat Color Icons, Rocketicons, Typicons, Themify Icons, VS Code Codicons, Heroicons, Heroicons 2, IcoMoon Free, Grommet Icons, css.gg, Ionicons, Ionicons 5, Font Awesome 5, Line Awesome, BoxIcons, Bootstrap Icons, Font Awesome 6, Game Icons, Material Design, Phosphor, Remix, Simple Icons, Lucide, and Tabler.
- [ ] Add intent tags such as navigation, commerce, communication, status, files, and accessibility. **Partial:** bilingual categories, search terms, and UI contexts are available in the generated catalog and validated for indexing for Weather Icons, Simple Line Icons, Feather Icons, Go Icons, Devicons, Radix Icons, Circum Icons, Flat Color Icons, Rocketicons, Typicons, Themify Icons, VS Code Codicons, Heroicons, Heroicons 2, IcoMoon Free, Grommet Icons, css.gg, Ionicons, Ant Design Icons, Ionicons 5, Font Awesome 5, Line Awesome, BoxIcons, Bootstrap Icons, Font Awesome 6, Game Icons, Material Design, Phosphor, Remix, Simple Icons, Lucide, and Tabler.
- [ ] Record visual properties such as filled, outlined, brand, directional, multicolor, and stroke support. **Partial:** deterministic properties are generated for enriched Weather Icons, Simple Line Icons, Feather Icons, Go Icons, Devicons, Radix Icons, Circum Icons, Flat Color Icons, Rocketicons, Typicons, Themify Icons, VS Code Codicons, Heroicons, Heroicons 2, IcoMoon Free, Grommet Icons, css.gg, Ionicons, Ant Design Icons, BoxIcons, Ionicons 5, Font Awesome 5, Line Awesome, Bootstrap Icons, Font Awesome 6, Game Icons, Material Design, Phosphor, Remix, Simple Icons, Lucide, and Tabler.
- [ ] Add negative guidance for easily confused icons. **Partial:** supported by the schema and present for ambiguous Weather Icons, Simple Line Icons, Feather Icons, Go Icons, Devicons, Radix Icons, Circum Icons, Flat Color Icons, Rocketicons, Typicons, Themify Icons, VS Code Codicons, Heroicons, Heroicons 2, IcoMoon Free, Grommet Icons, css.gg, Ionicons, and Lucide; Ionicons 5, Font Awesome 5, Line Awesome, BoxIcons, Bootstrap Icons, Font Awesome 6, Game Icons, Material Design, Phosphor, Remix, Simple Icons, and Tabler currently have no collection-specific negative guidance; negative terms are intentionally excluded from Algolia's positive search attributes.
