...
- [ ] Roll reviewed semantic metadata out to the remaining collections, prioritizing small and high-usage collections. **Partial:** Weather Icons, Simple Line Icons, Feather Icons, Go Icons, Devicons, Radix Icons, Circum Icons, Flat Color Icons, Rocketicons, Typicons, Themify Icons, VS Code Codicons, Heroicons, IcoMoon Free, Grommet Icons, css.gg, Ionicons, and Line Awesome have reviewed metadata for 8,062 icon bindings across 18 of 32 collections. BoxIcons adds complete generated coverage for 1,634 bindings (9,696 generated bindings across 19 collections), validated against its pinned source and the dry-run index; semantic review is still required before it is counted as reviewed. Go is verified against the lockfile-installed Octicons 19.34.0 catalog; Radix, Codicons, Grommet, and Line Awesome are verified against their current pinned revisions.
- [x] Refresh Go and Radix metadata against the current clean-build catalog.
- [ ] Normalize names and common aliases, such as `delete`, `trash`, and `remove`. **Partial:** implemented and materialized per icon for Weather Icons, Simple Line Icons, Feather Icons, Go Icons, Devicons, Radix Icons, Circum Icons, Flat Color Icons, Rocketicons, Typicons, Themify Icons, VS Code Codicons, Heroicons, IcoMoon Free, Grommet Icons, css.gg, Ionicons, and Line Awesome.
