...
- [ ] Create a reviewed benchmark of common icon-selection requests. **Partial:** collection-wide semantic invariants, unrelated alias leakage, and 120 bilingual intent cases across the sixteen collections added in this rollout are covered; a representative scored ranking corpus remains pending.
