...
- [ ] Add synonyms and semantic tags without changing stable icon IDs. **Partial:** reviewed English and PT-BR semantics cover all 219 Weather Icons, 189 Simple Line Icons, 287 Feather Icons, 352 Go Icons, 192 Devicons, 332 Radix Icons, 288 Circum Icons, 329 Flat Color Icons, 1 Rocketicons icon, 336 Typicons, 352 Themify Icons, 653 VS Code Codicons, 460 Heroicons, 491 IcoMoon Free icons, 637 Grommet Icons, 704 css.gg icons, 696 Ionicons, and 848 Ant Design Icons (7,366 total). BoxIcons has complete generated coverage for 1,634 bindings, validated structurally and in the dry-run index; its per-family semantic review remains outstanding. The other 13 collections remain pending.
...
- [ ] Roll reviewed semantic metadata out to the remaining collections, prioritizing small and high-usage collections. **Partial:** Weather Icons, Simple Line Icons, Feather Icons, Go Icons, Devicons, Radix Icons, Circum Icons, Flat Color Icons, Rocketicons, Typicons, Themify Icons, VS Code Codicons, Heroicons, IcoMoon Free, Grommet Icons, css.gg, Ionicons, and Ant Design Icons have reviewed metadata for 7,366 icon bindings across 18 of 32 collections. BoxIcons adds complete generated coverage for 1,634 bindings (9,000 generated bindings across 19 collections), validated against its pinned source and the dry-run index; semantic review is still required before it is counted as reviewed. Ant Design is verified against its pinned Git revision `7f2516ac91226d2b41f93b35cb5197c8d94f7189`; Go is verified against the lockfile-installed Octicons 19.34.0 catalog; Radix, Codicons, and Grommet are verified against their current pinned revisions.
