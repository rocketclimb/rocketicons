...
- [ ] Roll reviewed semantic metadata out to the remaining collections, prioritizing small and high-usage collections. **Partial:** Weather Icons, Simple Line Icons, Feather Icons, Go Icons, Devicons, Radix Icons, Circum Icons, Flat Color Icons, Rocketicons, Typicons, Themify Icons, VS Code Codicons, Heroicons, IcoMoon Free, Grommet Icons, css.gg, and Ionicons have reviewed metadata for 6,518 icon bindings across 17 of 32 collections. BoxIcons adds complete generated coverage for 1,634 bindings (8,152 generated bindings across 18 collections), validated against its pinned source and the dry-run index; semantic review is still required before it is counted as reviewed. Go is verified against the lockfile-installed Octicons 19.34.0 catalog; Radix, Codicons, and Grommet are verified against their current pinned revisions.
- [x] Refresh Go and Radix metadata against the current clean-build catalog.
- [ ] Normalize names and common aliases, such as `delete`, `trash`, and `remove`. **Partial:** implemented and materialized per icon for Weather Icons, Simple Line Icons, Feather Icons, Go Icons, Devicons, Radix Icons, Circum Icons, Flat Color Icons, Rocketicons, Typicons, Themify Icons, VS Code Codicons, Heroicons, IcoMoon Free, Grommet Icons, css.gg, Ionicons, and Ionicons 5.
...
- [ ] Record visual properties such as filled, outlined, brand, directional, multicolor, and stroke support. **Partial:** deterministic properties are generated for enriched Weather Icons, Simple Line Icons, Feather Icons, Go Icons, Devicons, Radix Icons, Circum Icons, Flat Color Icons, Rocketicons, Typicons, Themify Icons, VS Code Codicons, Heroicons, IcoMoon Free, Grommet Icons, css.gg, Ionicons, Ionicons 5, and BoxIcons.
- [ ] Add negative guidance for easily confused icons. **Partial:** supported by the schema and present for ambiguous Weather Icons, Simple Line Icons, Feather Icons, Go Icons, Devicons, Radix Icons, Circum Icons, Flat Color Icons, Rocketicons, Typicons, Themify Icons, VS Code Codicons, Heroicons, IcoMoon Free, Grommet Icons, css.gg, Ionicons, and Ionicons 5; negative terms are intentionally excluded from Algolia's positive search attributes.
