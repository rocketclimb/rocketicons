...
describe("handleClassName", () => {
  ...
  describe("full", () => {
    test("Should return default", () => {
      ...
      expect(className).toBe("icon-ri icon-default icon-filled icon-outlined");
    });

    test("Should return provided class", () => {
      const className = handleClassName("full", "icon-xl");

      expect(className).toBe("icon-ri icon-default icon-filled icon-outlined icon-xl");
    });
    ...
    test("Should return default and provided class", () => {
      ...
      expect(className).toBe(
        "icon-ri icon-default icon-filled icon-outlined border border-slate"
      );
    });
  });
});
