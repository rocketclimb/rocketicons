...
const IconInfo = ({ collectionId, info, Icon, onClose }: IconInfoProps) => {
  ...
  return (
    <div>
      <div className="relative flex flex-col px-3 py-2 border border-slate-200 dark:border-slate-700 rounded-xl">
        <Button
          onClick={() => onClose()}
        ...
        <div className="grid grid-cols-6">
          ...
          <div className="col-span-4">
            ...
            <CodeStyler variant="compact">
              <CodeElementBlock className="text-xs" component={info.compName} />
            </CodeStyler>
          </div>
          <div
          ...
          >
            <div>
              ...
              <p className="text-base text-slate-400">
                ...
                <a href="https://tailwindcss.com/docs/width">width</a> classes,
                however few helpers sizes classes are defined to make your work
                even easier. and few more words
              </p>
            </div>
