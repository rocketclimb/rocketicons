  ...
  (playgroundUrl && (
    <div className="pt-8 pl-2">
      <Link
        ...
        target="_blank"
      >
        <div className="mr-4 size-6 text-center rounded-md ring-1 ring-slate-900/5 shadow-sm group-hover/highligh-link:shadow group-hover/highligh-link:ring-slate-900/10 dark:ring-0 dark:shadow-none dark:group-hover/highligh-link:shadow-none dark:group-hover/highligh-link:highlight-white/10 group-hover/highligh-link:shadow-blue-200 dark:group-hover/highligh-link:bg-blue-500 dark:bg-slate-800 dark:highlight-white/5">
