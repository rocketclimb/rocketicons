...
} & PropsWithChildrenAndClassName & T;
...
const GenericDocElement = <T extends HTMLAttributes<HTMLElement>>({
  ...
  <Tag
    {...props}
    className={`${!overrideStyles && (defaultClassName || "")} ${
      className || ""
    }`}
  >
    {children}
...
const BaseDocElement = (props: BaseDocElementProps & GenericDocElementProps<HTMLAttributes<HTMLElement>>) => <GenericDocElement {...props} />

type AnchorDocElementProps = {
  Tag: AnchorTags;
}

export const AnchorDocElement = (props: AnchorDocElementProps & GenericDocElementProps<AnchorHTMLAttributes<HTMLElement>>) => <GenericDocElement {...props} />
