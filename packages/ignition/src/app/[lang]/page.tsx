...
const Home = ({ params: { lang } }: PropsWithLangParams) => {
  ...
  return (
    <div className="flex flex-col grow overflow-y-auto items-center justify-between bg-cover bg-hero-light dark:bg-hero-dark">
      <div className="relative w-full inset-0 before:absolute before:top-0 before:right-0 before:left-0 before:bottom-16 before:light-mask-image before:dark:dark-mask-image before:bg-grid before:bg-bottom before:bg-background-dark/[0.04] dark:before:bg-on-surface-dark/[0.05] dark:before:border-b before:border-surface-border-light dark:before:border-surface-border-light/10">
