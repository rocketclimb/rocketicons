...
const Layout = ({
  ...
  <ThemeContext>
    <ModalContext>
      <Header lang={lang} />
      <div className="antialiased mx-auto flex has-[.content-area]:content-area flex-col has-[.content-area]:px-0.5 has-[.content-area]:sm:px-8 has-[.content-area]:max-w-screen-2xl w-full text-slate-500 dark:text-slate-400">
